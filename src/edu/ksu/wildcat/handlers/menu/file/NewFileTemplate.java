...
/**
 * Handler for the "New File From Template" menu action which creates
 * a new file with a Dakota input file template
 *
 * @author geordypaul
 */
public class NewFileTemplate extends AbstractHandler implements IHandler {
	...
	private File createFile() {
		...
		dialog.setFileName("dakota_template.in");
